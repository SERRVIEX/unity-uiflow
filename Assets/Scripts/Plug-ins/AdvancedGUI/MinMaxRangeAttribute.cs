...
public class MixMaxRangeAttributeDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
    {
        ...
        Rect minRect = new Rect(rect) { width = MIN_MAX_SLIDER_TEXT_FIELD_WIDTH };
        Rect maxRect = new Rect(rect) { xMin = rect.xMax - MIN_MAX_SLIDER_TEXT_FIELD_WIDTH };
        Rect sliderRect = new Rect(rect) { xMin = minRect.xMax + 5f, xMax = maxRect.xMin - 5f };
